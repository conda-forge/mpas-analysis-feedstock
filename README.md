...
Once the `conda-forge` channel has been enabled, `mpas-analysis` can be installed with:

```
conda install mpas-analysis
```

It is possible to list all of the versions of `mpas-analysis` available on your platform with:
...
Updating mpas-analysis-feedstock
================================

If you would like to improve the mpas-analysis recipe or build a new
...
Note that all branches in the conda-forge/mpas-analysis-feedstock are
